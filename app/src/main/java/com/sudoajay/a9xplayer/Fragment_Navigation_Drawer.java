...
public class Fragment_Navigation_Drawer extends DrawerLayout {
    ...
    public Fragment_Navigation_Drawer(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public Fragment_Navigation_Drawer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Fragment_Navigation_Drawer(Context context) {
        super(context);
    }
